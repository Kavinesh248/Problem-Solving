...
Cache with Time Limit
    ...
    an integer value, and a duration in milliseconds. Once the duration has elapsed, 
    the key should be inaccessible. The method should return true if the same 
    un-expired key already exists and false otherwise. Both the value and duration 
    should be overwritten if the key already exists.
...
var TimiLimitedCached = function () {
  this.cache = {};
};

TimiLimitedCached.prototype.set = function (key, value, duration) {};
